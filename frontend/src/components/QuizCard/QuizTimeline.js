    ...
    render() {
        ...
        return (
            <div style={{marginTop: 16}}>
                ...
                <Row>
                    <Col span={11}>
                        <span style={{fontSize: 16, color: "black"}}>Due: {this.displayTimeLeft()}</span>
                    </Col>
                    <Col span={1}>
                        <Divider type="vertical"/>
                    </Col>
                    <Col span={12}>
                        <span style={{fontSize: 16, color: "black"}}>Status: {this.props.status ? this.props.status==="not_begin"?"Not started":this.props.status: "unknown"}</span>
                    </Col>
                </Row>
