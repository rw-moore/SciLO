				...
				<Row style={{ marginTop: 16 }}>
					<Col span={6}>
						...
						>
							<Select
								onChange={(e) => {
									var patt = this.responsePatterns.find(
										(val) => val.type === e
									);
									this.setState({
										customPatternDisable:
											patt.type !== 'Custom',
									});
									if (patt.type === 'Custom') {
										let newVal =
										...
										newVal.responses[
											...
											this.props.fetched.pattern || '';
										newVal.responses[
											this.props.index
										].patternflag =
											this.props.fetched.patternflag ||
											'';
										...
										newVal.responses[
											this.props.index
										].patternflag = patt.flags;
										this.props.form.setFieldsValue(newVal);
									}
								}}
							>
								{this.responsePatterns.map((patt) => (
									<Select.Option
										key={patt.type}
										value={patt.type}
									>
